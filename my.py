...
# if models.execute_kw(db, uid, password, 'estate.properties', 'create', [{'name': 'new xmlrpc data', 'state': 'new','excepted_price':'45000','postcode':'382870','date_avalibility':'2022-03-24','bedrooms':'3',}]):
#     print("Successfully created property")


# to_confrim_ids = models.execute_kw(db, uid, password, 'estate.properties', 'search', [['|', ('name', '=', 'new'), ('name', '=', 'Xmlrpc')]],{'limit':2})
# print ("\n\nto_confrim_id ::: ", to_confrim_ids)

# result = models.execute_kw(db, uid, password, 'estate.properties', 'cancel_property', [to_confrim_ids])

# result = models.execute_kw(db, uid, password, 'estate.properties', 'search_read', [[], ['name', 'postcode', 'state']])
